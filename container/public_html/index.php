...
<body>
	...
	<div class="page-wraper"> 
        ...
        <div class="page-content">
                    ...
                    <div class="tp-banner" >
                        ...
                        <div id="rev_slider_1014_1_wrapper" class="rev_slider_wrapper fullscreen-container" data-alias="typewriter-effect" data-source="gallery">
                           <div id="rev_slider_1014_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.1">
                                <ul>
                                        <!-- SLIDE 1 -->
                                        <li data-index="rs-1000" data-transition="fadethroughdark" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="2000"  data-thumb="media/images/construct-video1.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Creative" data-param1="01" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">

                                            <!-- MAIN IMAGE -->
                                            <img src="images/ars/big-roof.jpg" layout="responsive" width="1903" height="700" alt="St Louis Roofing and Construction"  data-bgposition="center center" data-bgfit="cover" class="rev-slidebg" data-no-retina/>
                                            <!-- LAYERS -->
                                    ...
                                    {"delay":"wait","speed":1000,"to":"opacity:0;","ease":"Power4.easeOut"}
                                            ...
                                            <div class="rs-background-video-layer"
                                                 ...
                                                 data-videomp4="https://firebasestorage.googleapis.com/v0/b/codestl-dev.appspot.com/o/ARS_Construction_House.mp4?alt=media&token=2da5e584-ef57-4358-beef-730f4939dcad"
                                            ...
                                            <div class="tp-caption  tp-resizeme"
                                                 ...
                                                 data-x="['left','left','left','left']" data-hoffset="['250','175','125','75']"
                                    ...
                                    color: rgba(255, 255, 255, 1.00);
                                    border-width:0px;">
                                                <span class="text-uppercase" style="font-family:'Roboto' ; ">Roofing Systems &<br>construction</span>
                                            </div>
                                            ...
                                            <div class="tp-caption  tp-resizeme"
                                                 ...
                                                 data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                                                 data-y="['top','top','top','top']" data-voffset="['400','400','400','380']"
                                    ...
                                    <span style="font-family:'Roboto';">Since 2001, We have proudly provided Wildwood, Eureka and the Greater St Louis area with top quality residential and commercial roofing and construction services.</span>
                                            ...
                                            <div class="tp-caption tp-resizeme"
                                                 ...
                                                 data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                                                 data-y="['top','top','top','top']" data-voffset="['500','500','550','550']"
            ...
            <!-- Slider END -->
            <div class="section-full overlay-wraper bg-cover bg-repeat-x bg-primary" style="background-image:url(images/background/bg7.png)">
                <div class="container">
                    ...
                    <div class="section-content">
                        <div class="owl-carousel home4-logo-carousel">
                            ...
                            <div class="item">
                                <div class="ow-client-logo">
                                    <div class="client-logo wt-img-effect on-color" >
                                        <a href="https://www.iko.com/" target="_blank"><img src="images/ars/iko-roofpro-sm.png"  alt="IKO Roofing Pro"></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="item">
                                <div class="ow-client-logo">
                                    <div class="client-logo wt-img-effect on-color" style="padding-top: 5em">
                                        <a href="https://www.genflex.com/" target="_blank"><img src="images/ars/genflex-sm.png"  alt="Gen Flex Roofing"></a>
                                    </div>
                                </div>
                            </div>
                            <!-- COLUMNS 3 -->
                            <div class="item">
                                <div class="ow-client-logo">
                                    <div class="client-logo wt-img-effect on-color" style="padding-top: 5em">
                                        <a href="https://malarkeyroofing.com/" target="_blank"><img src="images/ars/markley.png"  alt="Malarkey Roofing Products"></a>
                                    </div>
                                </div>
                            </div>
                            <!-- COLUMNS 4 -->
                            ...
                            <div class="item">
                                <div class="ow-client-logo">
                                    <div class="client-logo wt-img-effect on-color" style="padding-top: 5em">
                                        <a href="https://www.bbb.org/us/mo/wildwood/profile/general-contractor/advanced-roofing-systems-construction-llc-0734-310230062#sealclick" target="_blank"><img src="images/ars/bbb.png"  alt="Better Business Burro"></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="item">
                                <div class="ow-client-logo">
                                    <div class="client-logo wt-img-effect on-color">
                                        <a href="https://app.gethearth.com/financing/15237/19452?utm_campaign=15237&utm_content=general&utm_medium=contractor-website&utm_source=contractor&utm_term=19452" target="_blank"><img src="images/ars/150x150_hearth_badge.png"  alt="Hearth Financing"></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="item">
                                <div class="ow-client-logo">
                                    <div class="client-logo wt-img-effect on-color" style="padding-top: 5em">
                                        <a href="https://usio.com/" about="_blank"><img src="images/ars/final-usio-color.png" alt="Usio Payment Solutions"></a>
                                    </div>
                                </div>
                            </div>
                            <!-- COLUMNS 7 -->
            ...
            <div class="section-full bg-white p-t80 p-b50 scale-bg-top scale-bg-bottom">
                <div class="container">
                    ...
                    <div class="section-head text-center">
                        ...
                        <p>We only use top of the line materials to ensure your project is made of the best quality. We are certified dealers and installers of Malarky, IKO, Genflex roofing products.
                        ...
                        <div class="owl-carousel Home-services-carousel owl-btn-vertical-center">
                            ...
                            <div class="item">
                                <div class="wt-box bg-white">
                                    <div class="wt-media">
                                        <a href="javascript:void(0);"><img src="images/ars/day-care-sm.jpg"  alt="Commercial Roofing St Louis"></a>
                                    </div>
                            ...
                            <div class="item">
                                <div class="wt-box bg-white">
                                    <div class="wt-media">
                                        <a href="javascript:void(0);"><img src="images/ars/big-ranch/DJI_0439.jpg" alt="Residential Roofing St "></a>
                                    </div>
                                    <div class="wt-info p-tb30">
                            ...
                            <div class="item">
                                <div class="wt-box bg-white">
                                    <div class="wt-media">
                                        <a href="javascript:void(0);"><img src="images/ars/kitchen-contracting.jpg"  alt="Interior General Contracting"></a>
                                    </div>
                                    <div class="wt-info p-tb30">
                            ...
                            <div class="item">
                                <div class="wt-box bg-white">
                                    <div class="wt-media">
                                        <a href="javascript:void(0);"><img src="images/ars/halfroof.jpg"  alt="Exterior Genral Contracting"></a>
                                    </div>
                                    <div class="wt-info p-tb30">
                            ...
                            <div class="item">
                                <div class="wt-box bg-white">
                                    <div class="wt-media">
                                        <a href="javascript:void(0);"><img src="images/ars/different-hous.jpg" alt="Custom Roofing "></a>
                                    </div>
                                    <div class="wt-info p-tb30">
            ...
            <div class="section-full p-t80 p-b50 overlay-wraper bg-parallax"  data-stellar-background-ratio="0.5"  style="background-image:url(images/ars/crane.jpg)">
                <div class="overlay-main bg-black opacity-07"></div>
                <div class="container">
                    <!-- TITLE START -->
                    <div class="section-head text-center text-white">
                        <h2 class="text-uppercase">Pull From Google Reviews</h2>
                        <div class="wt-separator-outer">
                        ...
                        <div class="owl-carousel testimonial-one">
                            <div class="item">
                                <div class="testimonial-1 testimonial-bg">
                                    <div class="testimonial-pic  radius shadow"><img src="images/ars/crane.jpg"  alt="Commercial Roofing Services"></div>
                            ...
                            <div class="item">
                                <div class="testimonial-1 testimonial-bg">
                                    <div class="testimonial-pic  radius shadow"><img src="images/testimonials/pic2.jpg"  alt=""></div>
                                    <div class="testimonial-detail">
                                        <strong class="testimonial-name">Steve Jobs</strong>
                                        <span class="testimonial-position">Cfo Loop Inc</span>
                                    </div>
                            ...
                            <div class="item">
                                <div class="testimonial-1 testimonial-bg">
                                    <div class="testimonial-pic  radius shadow"><img src="images/testimonials/pic3.jpg" alt=""></div>
                                    <div class="testimonial-detail">
                                        <strong class="testimonial-name">Steve Jobs</strong>
                                        <span class="testimonial-position">Cfo Loop Inc</span>
                                    </div>
            ...
            <div class="section-full bg-gray p-t80 p-b120 bg-no-repeat bg-bottom-right" style="background-image:url(images/background/pic-c-1bg.png);">
                <div class="container">
                    <!-- TITLE START-->
                    <div class="section-head text-center">
                            ...
                            <div class="col-md-6 col-sm-6 p-tb15">
                                <div class="wt-icon-box-wraper  p-a20 left bg-white">
                                    ...
                                    <div class="icon-content">
                                        ...
                                        <p>Lorem Ipsum is simply dummy text of the printing and typesg indtrysum has been the Ipsum dummy of the printing.</p>
                                    </div>
                                </div>
                            </div>
                            <!-- COLUMNS 2 -->
                                ...
                                <div class="wt-icon-box-wraper  p-a20 left bg-white">
                                    ...
                                    <div class="icon-content ">
                                        ...
                                        <video width="100%" controls>
                                            <source src="https://firebasestorage.googleapis.com/v0/b/codestl-dev.appspot.com/o/ARS_Malarkey_Promo_4K.mp4?alt=media&token=24630ddc-9c4f-47cd-9def-00513ed83618" type="video/mp4">
                                        </video>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="section-full  p-t50 p-b10 overlay-wraper bg-repeat"  data-stellar-background-ratio="0.5"  style="background-image:url(images/ars/crane.jpg)">
            	<div class="overlay-main bg-black opacity-07"></div>
                <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="m-b30 text-white text-center">
                                    ...
                                    <div class="counter font-26 font-weight-800 m-b5">1000</div><b>+</b>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="m-b30  text-white text-center">
                                    ...
                                    <div class="counter font-26 font-weight-800 m-b5">4500</div><b>+</b>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="m-b30 text-white text-center">
                                    ...
                                    <div class="counter font-26 font-weight-800 m-b5">20000</div><b>+</b>
          ...
          <div class="modal-dialog modal-sm">
            ...
            <div class="modal-content">
              ...
              <div class="modal-footer text-center">
                  <div class="text-center"><img src="images/logo-dark.png" alt="ARS Construction Logo"></div>
              </div>
            </div>
          </div>
        </div>
